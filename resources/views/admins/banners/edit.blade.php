    ...
    <section class="section dashboard">
        <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="{{ route('banners.update', ['banner' => $banner->id]) }}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <img src="{{ asset($banner->banner_url) }}" width="100%" alt="">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    ...
                    <select name="is_active" id="statusBanner" class="form-select mt-2">
                        <option {{ $banner->is_active == 1 ? 'selected' : '' }} value="1">Is active</option>
                        <option {{ $banner->is_active == 0 ? 'selected' : '' }} value="0">Temporarily locked</option>
                    </select>
                  </div>
                </div>
                <div>
