              ...
              <form method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    ...
                    <input type="text" id="nameProduct" name="name_product" placeholder="Name product..." class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="price" id="price" placeholder="Price product..." class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <label for="newPrice" class="col-sm-2 col-form-label fw-bold">New price</label>
                    <input type="text" name="new_price" id="newPrice" placeholder="New price product..." class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    ...
                    <select name="has_variants" id="has_variants" class="form-select">
                      ...
                      <option value="1">Is variant</option>
                  </select>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                    ...
                    <select name="is_active" id="is_active" class="form-select">
                      ...
                      <option value="1">Temporary lock</option>
                  </select>
                  </div>
                </div>
                <div>
