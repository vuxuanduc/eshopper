...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <h3 class="font-weight-semi-bold mb-4">${{ $product->new_price != "" ? $product->new_price : $product->price }}</h3>
            ...
            <div class="d-flex align-items-center mb-4 pt-2">
                <form action="{{ url('check-out') }}" class="d-flex" method="GET">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="hidden" name="price" value="{{ $product->new_price != "" ? $product->new_price : $product->price }}">
...
<div class="container-fluid py-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Sản phẩm cùng danh mục</span></h2>
    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div
                        ...
                        <img class="img-fluid w-100" src="{{ asset($item->avatar) }}" alt="">
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="{{ url('detail-product/' .$item->id) }}" class="btn btn-sm text-dark p-0"><i
                        ...
                        <form action="{{ url('addToCart') }}" method="POST">
                            ...
                            <input type="hidden" name="image" value="{{ $item->avatar }}">
                            <input type="hidden" name="price" value="{{ $item->new_price != "" ? $item->new_price : $item->price }}">
